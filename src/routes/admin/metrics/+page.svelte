...
<AdminPage title={m.metr_title()} subtitle={m.metr_subtitle()} icon={Activity} maxWidth="1100px">
  {#snippet actions()}
    ...
    <div class="cards">
      <section class="card">
        ...
        <dl class="kv">
          <div>
            <dt>Uptime</dt>
            <dd>{formatUptime(metrics.process.uptimeSeconds)}</dd>
          </div>
          <div>
            <dt>Node</dt>
      ...
      <section class="card">
        ...
        <dl class="kv">
          <div>
            <dt>RSS</dt>
            <dd class="strong">{formatBytes(metrics.process.memory.rss)}</dd>
          </div>
          <div>
            <dt>{m.metr_heap_used()}</dt>
            <dd>{formatBytes(metrics.process.memory.heapUsed)}</dd>
          </div>
          <div>
            <dt>Heap total</dt>
            <dd>{formatBytes(metrics.process.memory.heapTotal)}</dd>
          </div>
          <div>
            <dt>External</dt>
