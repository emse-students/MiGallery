<script lang="ts">
  ...
  const icons: Record<string, string> = {
    ...
    'upload-cloud': '<path d="M16 16l-4-4-4 4" /><path d="M12 12v8" /><path d="M20.39 18.39A5 5 0 0 0 18 9h-1.26A8 8 0 1 0 4 16.3" />',
    ...
    // --- Misc ---
    tag: '<path d="M20.59 13.41L13.41 20.59a2 2 0 0 1-2.83 0L3.41 13.41a2 2 0 0 1 0-2.83L10.59 3.41a2 2 0 0 1 2.83 0l6.59 6.59a2 2 0 0 1 0 2.83z" /><circle cx="9" cy="9" r="1" />',
    ...
    'scan-face': '<path d="M3 7V5a2 2 0 0 1 2-2h2" /><path d="M17 3h2a2 2 0 0 1 2 2v2" /><path d="M21 17v2a2 2 0 0 1-2 2h-2" /><path d="M7 21H5a2 2 0 0 1-2-2v-2" /><rect x="7" y="7" width="10" height="10" rx="2" ry="2" /><path d="M9 10h.01" /><path d="M15 10h.01" /><path d="M9.5 15a3.5 3.5 0 0 0 5 0" />',
    copyright: '<circle cx="12" cy="12" r="10" /><path d="M15 9.354a4 4 0 1 0 0 5.292" />',
...
>
  {#if icons[name]}
    {@html icons[name]}
  {:else}
    <!-- Fallback if icon is missing (prevents silent error) -->
